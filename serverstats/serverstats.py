"""
This, in no way, is me copying the code. It is simplying here to make future updates. 

You may find the source code here
https://github.com/DAzVise/modmail-plugins/blob/master/serverstats/serverstats.py
"""
